...
if (missingEnvVars.length > 0) {
    ...
    console.log('MONGODB_URL=mongodb://localhost:27017 (optional)');
    console.log('PORT=4000 (optional)');
    process.exit(1);
}
...
if (!process.env.MONGODB_URL) {
    ...
    console.log('⚠️ MONGODB_URL not provided, using default: mongodb://localhost:27017');
}
